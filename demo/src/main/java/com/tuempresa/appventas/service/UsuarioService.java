...
public class UsuarioService {
    ...
    public Usuario registrarUsuario(Usuario usuario) {
        ...
        // ASIGNAR TIPO USUARIO POR DEFECTO SI NO SE ESPECIFICA
        ...
        System.out.println(">>> TOKEN DE VERIFICACIÓN GENERADO PARA " + usuario.getEmail() + ": " + token);
        ...
        try {
            ...
            System.out.println(">>> TOKEN MANUAL (USAR SI EL EMAIL FALLA): " + token);
        }

        return usuarioGuardado;
    }

    // LOGIN - NO permite acceso sin verificar email
    ...
    // NUEVO: Método para crear usuarios con roles específicos
    public Usuario crearUsuarioConRol(Usuario usuario, String rol) {
        if (!List.of("USUARIO", "VENDEDOR", "MODERADOR", "ADMINISTRADOR").contains(rol)) {
            throw new RuntimeException("Rol inválido. Roles válidos: USUARIO, VENDEDOR, MODERADOR, ADMINISTRADOR");
        }
        ...
        usuario.setCuentaVerificada(true); // Saltar verificación para admin/moderadores
    ...
    // Eliminar todos los usuarios (SOLO PARA DESARROLLO/DEBUG)
