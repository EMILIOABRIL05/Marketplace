...
public class Reporte {
    ...
    // 🆕 NUEVO: Soporte para reportar servicios
    @ManyToOne
    @JoinColumn(name = "servicio_id")
    private Servicio servicio;

    private String motivo; // SPAM, CONTENIDO_INAPROPIADO, FRAUDE, PRECIO_INCORRECTO, SERVICIO_NO_DISPONIBLE, OTRO
    ...
    // 🆕 Constructor para servicios
    public Reporte(Usuario usuario, Servicio servicio, String motivo, String descripcion) {
        this.usuario = usuario;
